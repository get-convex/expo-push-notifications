...
export type NotificationStatus = Infer<typeof vNotificationStatus>;

export type NotificationId = string & { __isNotificationId: true };
export const vNotificationId = v.string() as VString<NotificationId>;
